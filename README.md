...
- [CRS.md](/home/yklee/repos/devops_assistant/docs/requirements/CRS.md): KPI 12개 핵심 지표와 메인 페이지 요구사항을 포함한 고객 요구사항 문서
- [SRS.md](/home/yklee/repos/devops_assistant/docs/requirements/SRS.md): KPI 12개 표시, 메인 대시보드, 프로젝트 목록/상세, 상단 검색, 시계열/조직 필터, 소스코드 품질 탭, 개인 할 일, 경고/알림 요구를 분석한 소프트웨어 요구사항 문서
...
- 메인 페이지 상단에 KPI 12개 항목을 잘 보이게 배치한다.
...
- KPI 12개 항목의 상세 정의와 소스코드 품질 세부 측정 기준은 이후 단계에서 구체화한다.
