...
- [CRS.md](/home/yklee/repos/devops_assistant/docs/requirements/CRS.md): 프로젝트 컨셉과 메인 페이지 요구사항을 정리한 고객 요구사항 문서
- [SRS.md](/home/yklee/repos/devops_assistant/docs/requirements/SRS.md): 메인 대시보드, 프로젝트 목록/상세, 상단 검색, 시계열/조직 필터, 소스코드 품질 탭, 개인 할 일, 경고/알림 요구를 분석한 소프트웨어 요구사항 문서
...
- KPI 지표와 소스코드 품질 세부 측정 기준은 이후 단계에서 구체화한다.
